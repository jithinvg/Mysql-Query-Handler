...
class DataBaseHandler {
    ...
    /*
     * Opens a database with the constants set in nvooy_user_db_config.php configuration file
     ...
     *
     * */
    public function createUpdateQuery($tableName,$queryArray,$conditionArray){
    ...
    public function createReadQuery($tableName,$queryArray=0,$conditionArray=0){
        $query="SELECT ";
